 ...
 */
export const PUBLISHED_IMAGE_REPO = "ryvexam/ryvoko";
...
export const IMAGE_TAG_ENV = "RYVOKO_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "RYVOKO_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "ryvoko-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "RYVOKO_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Ryvoko image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `RYVOKO_UPDATER_URL` (Compose prod always sets
