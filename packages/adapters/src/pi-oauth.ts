...
> = {
  [CHATGPT_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with ChatGPT Plus or Pro. Uses your OpenAI subscription. Ryvoko does not pay.",
  },
  [COPILOT_OAUTH_PROVIDER]: {
    mode: "device-code",
    loginLabel: "Sign in with GitHub Copilot",
    hint: "Copilot",
    billing: "Sign in with GitHub Copilot. Uses your Copilot subscription. Ryvoko does not pay.",
  },
  [XAI_OAUTH_PROVIDER]: {
    mode: "device-code",
    loginLabel: "Sign in with SuperGrok or X Premium",
    hint: "SuperGrok / key",
    billing: "Sign in with SuperGrok or X Premium, or paste an xAI API key. Ryvoko does not pay.",
  },
