...
import { DEFAULT_MODEL_CONTEXT_WINDOW, DEFAULT_MODEL_MAX_TOKENS } from "@ryvoko/contracts";
...
export const OPENAI_COMPATIBLE_VISION_MODELS_ENV = "RYVOKO_OPENAI_COMPATIBLE_VISION_MODELS";
