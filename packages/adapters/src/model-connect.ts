...
import type { ModelConnectInput, ModelCredential, ThinkingLevel } from "@ryvoko/contracts";
import { OPENAI_COMPATIBLE_PROVIDER_ID as CONTRACT_OPENAI_COMPAT } from "@ryvoko/contracts";
