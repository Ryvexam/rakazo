...
/** Seeded ryvoko releases so evals succeed without the public internet. */
export const DEFAULT_RYVOKO_EMULATED_RELEASES: readonly EmulatedGithubRelease[] = [
  {
    owner: "Ryvexam",
    repo: "ryvoko",
    tag: "v0.4.2",
    ...
    htmlUrl: "https://github.com/Ryvexam/ryvoko/releases/tag/v0.4.2",
  },
  {
    owner: "Ryvexam",
    repo: "ryvoko",
    ...
    htmlUrl: "https://github.com/Ryvexam/ryvoko/releases/tag/v0.4.1",
  },
];
...
export function assessReleaseWatchRoutinePrompt(prompt: string): {
  ...
  const mentionsRepo = /ryvoko|Ryvexam/i.test(text);
  ...
  if (!mentionsRepo || !mentionsReleases || !mentionsGithubTool) {
    const missing = [
      !mentionsRepo ? "repo (Ryvexam/ryvoko)" : null,
