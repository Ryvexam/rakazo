...
const VISION_ENV = "RYVOKO_OPENAI_COMPATIBLE_VISION_MODELS";
const LOCAL_VISION_ENV = "RYVOKO_LOCAL_VISION_MODELS";
...
describe("operator-declared vision modalities", () => {
  ...
  it("applies the same declaration to the local provider", async () => {
    await withEnv(
      { RYVOKO_LOCAL_MODELS: "qwen3-vl,qwen3-text", [LOCAL_VISION_ENV]: "qwen3-vl" },
      async () => {
