...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Ryvoko · browser checks</p>
        <h1>Playwright</h1>
      ...
      <div class="actions">
        ...
        <a class="button" href="https://github.com/Ryvexam/ryvoko/actions">GitHub Actions</a>
      </div>
    </header>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>${mobile ? "Android screenshots" : "Run screenshots"} · Ryvoko</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">Ryvoko · visual review</p>
  ...
  <script>
    ...
    const storageKey = "ryvoko-playwright-gallery-columns";
