import type { TransactionalEmail } from "@ryvoko/adapter-kit";
import { bootstrapUserSpace } from "@ryvoko/db";
...
vi.mock("@ryvoko/db", () => ({ bootstrapUserSpace: vi.fn(async () => ({ spaceId: "space-1" })) }));
