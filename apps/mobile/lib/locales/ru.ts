export const RU_MESSAGES: Record<string, string> = {
  ...
  "Enter your Ryvoko server address.": "Введите адрес вашего сервера Ryvoko.",
  "Show less": "Свернуть",
  Members: "Участники",
  ...
  "Point this app at your self-hosted Ryvoko origin, the same HTTPS URL you open in a browser.":
    "Направьте это приложение на свой собственный источник Ryvoko, тот же URL-адрес HTTPS, который вы открываете в браузере.",
  Private: "Личный",
  ...
  "Sign in": "Войти",
  "Sign in to Ryvoko": "Войти в Ryvoko",
  "Sign out": "Выйти",
  "Sign up": "Зарегистрироваться",
  "Sign up for Ryvoko": "Зарегистрироваться в Ryvoko",
  "Sign-in": "Вход",
  "Sign-up": "Регистрация",
  ...
  "That URL did not look like a Ryvoko server": "Этот адрес не похож на сервер Ryvoko",
  ...
  "Paste the OpenAI-compatible address from your server. Ryvoko adds /v1 if needed.":
    "Вставьте OpenAI-совместимый адрес со своего сервера. При необходимости Ryvoko добавляет /v1.",
  ...
  "This subscription sign-in is not available in Ryvoko yet. Use a deployment credential or choose another provider.":
    "Вход по этой подписке пока недоступен в Ryvoko. Используйте учётные данные развёртывания или выберите другого провайдера.",
  ...
  "Account default": "Голос аккаунта",
  "Add to favorites": "Добавить в избранное",
  Alias: "Псевдоним",
  All: "Все",
  "Bot voices": "Голоса ботов",
  "Could not save that alias": "Не удалось сохранить этот псевдоним",
  "Could not save that bot voice": "Не удалось сохранить голос бота",
  "Could not save that model": "Не удалось сохранить эту модель",
  "Could not update favorites": "Не удалось обновить избранное",
  Favorites: "Избранное",
  "Remove from favorites": "Убрать из избранного",
  "Search voices": "Искать голоса",
  "Unavailable voice": "Недоступный голос",
  "Voice library": "Библиотека голосов",
};
