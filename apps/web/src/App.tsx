...
import { LOCAL_SETTINGS_PAGE } from "@ryvoko/contracts";
import { Button, Skeleton } from "@ryvoko/ui-web";
...
function SessionApp() {
  ...
  if (gate === "loading") {
    return window.location.pathname.startsWith("/app") ? (
      ...
      <div
        ...
        data-ryvoko-app-state="session-pending"
      >
        <Trans>Loading…</Trans>
      </div>
    );
  ...
  return (
    <div className="h-full" data-ryvoko-app-state="ready">
