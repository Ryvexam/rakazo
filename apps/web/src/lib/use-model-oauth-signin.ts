import type { ModelOAuthBegin } from "@ryvoko/contracts";
import { cancelModelOAuthAttempt, finishModelOAuthAttempt } from "@ryvoko/core";
  ...
  async function startSubscriptionSignIn(begin: ModelOAuthSignInBegin) {
    ...
    try {
      ...
      if (browserAuth?.open) {
        ...
        window.open(started.verificationUri, "ryvoko-model-oauth", "noopener,noreferrer");
      }
