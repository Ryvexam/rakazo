...
import type { Me, ThinkingLevel } from "@ryvoko/contracts";
import {
...
import { createModelProbe, initialModelProbeState } from "@ryvoko/core";
import {
  Button,
  Dialog,
  DialogClose,
...
export function ModelSettingsOverlay({
  ...
  const description = loading ? (
    ...
    <Trans>Choose which connected model Ryvoko uses.</Trans>
  );
              ...
              filteredGroups.map((group) => {
                ...
                return (
                  <Button
                    ...
                    className={`h-auto w-full items-center justify-start gap-3 border-b border-border px-3.5 py-3 text-start last:border-0 ${
            ...
            <>
                ...
                {isOpenAiCompatible ? (
                  <>
                    ...
                    <details className="mt-2 text-[13px] leading-[1.5] text-muted-foreground">
                      ...
                      <p className="mt-1">
                        {t`Paste the OpenAI-compatible address from your server. Ryvoko adds /v1 if needed.`}
                      </p>
                    </details>
              ...
              {selected.auth === "oauth" && !subscriptionSignIn ? (
                <p className="mt-5 text-sm leading-[1.5] text-muted-foreground">
                  <Trans>
                    This subscription sign-in is not available in Ryvoko yet. Use a deployment
...
function ModelOption({
  ...
  return (
    <Button
      ...
      className={`h-auto w-full items-center justify-between gap-3 px-3 py-2 text-start text-[13.5px] text-foreground outline-none hover:bg-accent focus-visible:bg-accent ${
