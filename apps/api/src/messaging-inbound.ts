import type { JobPublisher, MessagingInboundMessage } from "@ryvoko/adapter-kit";
import { messagingDeliverJob, runContinueJob } from "@ryvoko/adapter-kit";
import type { MessageBlock } from "@ryvoko/contracts";
import { parseMessagingCommand, sanitizeMessagingLabel } from "@ryvoko/core";
import type {
      ...
      data: [
        {
          ...
          body: "Hi. This line hosts Ryvoko personal agents. Some people in this group haven't messaged it yet; send any message to this line first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your Ryvoko agent. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
