...
Email **security@ryvoko.com** only. Do not open public GitHub issues for security bugs.
...
- General support: **support@ryvoko.com**
- Maintainer: **elie@ryvoko.com**

## Scope

This policy covers the Ryvoko self-hosted product in **this repository**.
